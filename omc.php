...
EURONEAR - Tools - O-C Calculator
</b></font> 
<br><br>

Description: Derives observed minus calculated (O-C) residuals for known asteroids (NEAs or others) continuous observation.  <br> 
Input: Observing report (including header) including one or many asteroid observations, in Minor Planet Centre (MPC) format. <br>
...
Queries: The <a href="http://newton.dm.unipi.it/neodys/">NEODyS</a> and <a href="http://hamilton.dm.unipi.it/astdys/">AstDyS</a> 
         services (Milani et al., Univ Pisa). <br>
...
- Include in the acknowledgement: "This paper used the EURONEAR O-C Calculator \footnote{http://www.euronear.org/tools/omc.php}". <br>

<br>
Author: Ruxandra Valcu, Ovidiu Vaduvescu (2018)
<br><br>
